...
class ExampleHostApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: ExampleHostApi?, messageChannelSuffix: String = "") {
    ...
    let getHostLanguageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.qrscan_native.ExampleHostApi.getHostLanguage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let addChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.qrscan_native.ExampleHostApi.add\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let sendMessageChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.qrscan_native.ExampleHostApi.sendMessage\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
